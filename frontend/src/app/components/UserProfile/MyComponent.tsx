...
export default function MyComponent() {
  ...
  const PaginationNav = () => {
    ...
    className="object-contain shrink-0 w-5 opacity-50 aspect-square" // Apply the same styling
  />
        </button>
        {renderPageButtons()}
        <button
        ...
        >
           <FontAwesomeIcon
    icon={faArrowRight} // Use the right arrow icon for "Next"
    className="object-contain shrink-0 w-5 aspect-square" // Apply the same styling
  />
        </button>
      </nav>
    );
