  ...
  const PaginationNav = () => {
    ...
    return (
      ...
      >
        ...
        >
          {/* <img
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/e0acea081f95ac26aaf8f49185801cc04964bdc79522508d3d6f922df979b0e1?placeholderIfAbsent=true&apiKey=c20b4089c62f47e3b73547d56c34685d"
            alt="Previous"
            className="object-contain shrink-0 w-5 opacity-50 aspect-square"
          /> */}
          <PlayArrowIcon/>
        </button>
        {renderPageButtons()}
        ...
        >
          {/* <img
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/91364f32f90b1adfb55be8d03aaf08b853d5954bf643b452f105b7db93fbe3af?placeholderIfAbsent=true&apiKey=c20b4089c62f47e3b73547d56c34685d"
            alt="Next"
